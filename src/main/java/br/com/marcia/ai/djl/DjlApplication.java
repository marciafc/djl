...
public class DjlApplication implements CommandLineRunner {

	private static final Logger LOG = LoggerFactory.getLogger(DjlApplication.class);
	...
	public void run(String... args) throws Exception {
		...
		var imagens = new org.springframework.core.io.Resource[] {
				...
				new ClassPathResource("/marcia1.png"),
				new ClassPathResource("/marcia2.jpg"),
				new ClassPathResource("/marcia3.jpg"),
